...
import styles from './NoteCardMobile.module.css';
...
const NoteCardMobile = ({ title, content, timestamp, label, id }) => {
        ...
        <div className={styles.noteContainer}>
            ...
            <div className={styles.footerContainer}>
                ...
                <IconButton className={styles.moreBtn}
                    ...
                    >
                        <MenuItem sx={ isMobile ? { padding: '0rem 1rem', fontSize: 16 } : null} onClick={deleteNote}>
                        <Delete sx={ isMobile ? {fontSize: 18, color: 'grey', marginRight: '10px'} : {color: 'grey', fontSize: 20, marginRight: '10px'}} />
