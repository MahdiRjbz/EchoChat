...
import styles from './NoteMobile.module.css';
...
import NoteCard from './NoteCardMobile';
            ...
            <div className={styles.contentContainer}>
                <div className={styles.inputsContainer}>
                        <FormControl fullWidth sx={{display: 'grid', gridTemplateColumns: 'auto auto', columnGap: '.5rem'}}>
                            <InputLabel sx={{zIndex: '1'}} id="demo-simple-select-label">Filter</InputLabel>
                            <Select
                            ...
                            <OutlinedInput sx={{backgroundColor: 'white'}} placeholder='Search in Notes' value={search} onChange={(e) => setSearch(e.target.value)} size='small' />
                </div>
